            ...
            <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                ...
                >
                    <div className="max-w-xl lg:max-w-3xl">
                        <a className="block text-indigo-600">
                        ...
                        <h1 className="mt-6 text-2xl font-boldsm:text-3xl md:text-4xl">
                            Welcome to Educator 📚
                        </h1>
                        ...
                        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                            ...
                            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                <button
                                    className="inline-block shrink-0 rounded-md border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-indigo-700 focus:outline-none"
                                >
                                    Create an account
                                </button>
